  ...
  return (
    <div className="visuals">
      ...
      <div className="visual__btns">
         ...
         <button><a href = "https://pranavs-portfolio-one.vercel.app/" target="_blank" rel="noreferrer" style={{ color: "yellow", textDecoration: "none", fontWeight: "bolder" }}>Other Projects</a></button>
      </div>
